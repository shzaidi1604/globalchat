...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String userProvideUsername = userProvider.userName;
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
          ...
          child: Padding(
            ...
            child: CircleAvatar(child: Text(userProvideUsername[0])),
          ),
        ),
      ),
      drawer: Drawer(
          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                leading: CircleAvatar(child: Text(userProvideUsername[0])),
                title: Text(
